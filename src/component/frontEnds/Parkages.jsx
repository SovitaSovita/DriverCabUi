                    ...
                    <div className="mt-6">
                        <div className="main-hot-deal flex justify-between">
                            <div className="grid grid-cols-12 gap-4">
                                {
                                    data?.map((item) => (
                                        <div className="lg:col-span-6 md:col-span-6 col-span-12 cursor-pointer" onClick={() => handleParkageDetail(item.id)}>
                                            <div className="grid grid-cols-12 bg-white" data-aos="zoom-in" data-aos-duration="100">
